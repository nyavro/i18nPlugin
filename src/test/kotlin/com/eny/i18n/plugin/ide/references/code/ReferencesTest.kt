...
abstract class ReferenceTestVue(private val tg: TranslationGenerator): PlatformBaseTest() {
...
abstract class ReferenceTestPhp(private val tg: TranslationGenerator) : PlatformBaseTest() {
