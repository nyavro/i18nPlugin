...
abstract class CreateKeyTest(private val cg: CodeGenerator, private val tg: TranslationGenerator): PlatformBaseTest() {
    ...
    @Test
    fun createKeyMultipleTranslations() {
        val defaultNs = true
        val translationFileName = (if (defaultNs) "translation" else "test") + "." + tg.ext()
        val ns = if (defaultNs) "" else "test:"
        myFixture.addFileToProject(
...
//
//    @Test
//    fun createKeyMultipleTranslationsVue() = myFixture.runVue {
...
class CreateKeyTestJsJson: CreateKeyTest(JsCodeGenerator(), JsonTranslationGenerator())
class CreateKeyTestJsYaml: CreateKeyTest(JsCodeGenerator(), YamlTranslationGenerator())
class CreateKeyTestJsxJson: CreateKeyTest(JsxCodeGenerator(), JsonTranslationGenerator())
class CreateKeyTestJsxYaml: CreateKeyTest(JsxCodeGenerator(), YamlTranslationGenerator())
class CreateKeyTestTsJson: CreateKeyTest(TsCodeGenerator(), JsonTranslationGenerator())
class CreateKeyTestTsYaml: CreateKeyTest(TsCodeGenerator(), YamlTranslationGenerator())
class CreateKeyTestTsxJson: CreateKeyTest(TsxCodeGenerator(), JsonTranslationGenerator())
class CreateKeyTestTsxYaml: CreateKeyTest(TsxCodeGenerator(), YamlTranslationGenerator())


class CreateKeyBorderCasesTest: PlatformBaseTest() {
