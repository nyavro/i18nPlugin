...
class SfcTestArgumentsProvider : ArgumentsProvider {
    override fun provideArguments(context: ExtensionContext?): Stream<out Arguments> {
        ...
        val translationBlock = tg.generateNamedBlocks(
        ...
        return listOf(
            Pair(
                VueSfcCodeGenerator(
                    translationBlock
                ).generateBlock("message: {{ \$t(\"<caret>key2\") }}"),
                "Guten Tag!"
            )
//            Pair(
//                VueSfcCodeGenerator(
...
//                    )
//                ).generateBlock("<p>message: {{ \$t(\"<caret>key2\") }}</p>"),
...
//                    )
//                ).generateBlock("<p>message: {{ \$t(\"tst3.<caret>key\") }}</p>"),
//                "こんにちは、世界！"
//            ),
//            Pair(
//                VueSfcCodeGenerator(
...
//                    )
//                ).generateBlock("<p>message: {{ \$t(\"tst3.sfc.<caret>key\") }}</p>"),
//                "こんにちは、世界！"
//            ),
//            Pair(
//                VueSfcCodeGenerator(
...
//                        Pair("ja", tg.generate("tst3", arrayOf("sfc", "key", "こんにちは、世界！"), arrayOf("branch", "key", "こ")))
//                    )
//                ).generateBlock("<p>message: {{ \$t(\"tst3.sfc.<caret>key.sub\") }}</p>"),
//                "こんにちは、世界！"
//            )
