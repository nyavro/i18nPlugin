...
public interface I18nTypes {
  ...
  IElementType KEY_ITEM = new I18nElementType("KEY_ITEM");
  IElementType NAMESPACE = new I18nElementType("NAMESPACE");
  IElementType ROOT = new I18nElementType("ROOT");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == COMPOSITE_KEY) {
        ...
        return new I18nKeyItemImpl(node);
      }
      else if (type == NAMESPACE) {
        return new I18nNamespaceImpl(node);
      }
      else if (type == ROOT) {
        return new I18nRootImpl(node);
      }
